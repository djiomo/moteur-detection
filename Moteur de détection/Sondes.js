var Sondes={
    ...
    _connectionType:function () {
        return navigator.connection.type;
    },
    _cookieIsEnabled:function () {
        return(navigator.cookieEnabled);
    },
    _javaIsEnabld:function () {
    ...
    _hardwareConcurrencyfunction:function(){
        return navigator.hardwareConcurrency;
    },
    _osVersion:function (){
        if(Sondes._computerOs()=="Windows"){
